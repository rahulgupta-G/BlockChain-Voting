...
$('.modal').modal();
	...
	$('#vote1').click(function(){
		contractInstance.voteForCandidate('Sanat', {from: web3.eth.accounts[0]}, function() {
			console.log(contractInstance.totalVotesFor.call('Sanat').toString());
		    console.log(contractInstance.totalVotesFor.call('Aniket').toString());
		    console.log(contractInstance.totalVotesFor.call('Mandar').toString());
		    console.log(contractInstance.totalVotesFor.call('Akshay').toString());
